...
//!
//! **Status:** this crate currently defines the trait and its shared
//! parameter/result types only (`src/store.rs`). The SurrealDB-embedded
//! implementation (`SurrealStore`) lands in subsequent tasks — see
